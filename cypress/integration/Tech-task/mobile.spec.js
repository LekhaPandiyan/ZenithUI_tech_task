...
describe("To run a cypress tech task", () => {
  ...
  it("Verifying Who we are", () => {
    ...
    cy.get(".menu-item-8820 > .js-toggle-sub-nav > .nav__link-icon").should(
      "be.visible"
    );

    cy.get(".menu-item-8820 > .js-toggle-sub-nav > .nav__link-icon").trigger(
      "click"
    );
  });
  ...
  it("veryfing personal info", () => {
    ...
    cy.get(
      ".menu-item-158 > .nav__sub > .wrap > .content-wrap-nav > .grid > :nth-child(1) > .nav__sub-description"
    ).should("be.visible");
    ...
    cy.get(
      ".menu-item-158 > .nav__sub > .wrap > .content-wrap-nav > .grid > :nth-child(1) > .nav__sub-description"
    ).should("be.contain.text", "personal");
